...
SQLALCHEMY_DATABASE_URI = 'mysql://root:password@localhost/database' # << use this for MySQL, adjust accordingly
#SQLALCHEMY_DATABASE_URI = 'sqlite:///' + os.path.join(basedir, 'app.db') << use this for SQLite, adjust accordingly
